...
with open(f"hdfs://localhost:9092/transactions/imports/social_media_{now}.txt", "w") as txt_file:
    # Écrire l'en-tête
...
with open(f"hdfs://localhost:9092/transactions/imports/social_media_{now}.json", "w") as json_file:

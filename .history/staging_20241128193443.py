...
def process_files(file_type):
    file_paths = []
    delta_path = "/transactions/staging/"  # Répertoire de staging Delta dans HDFS
    ...
    for file_path in file_paths:
        ...
        if file_path.startswith("hdfs://localhost:9000"):
            ...
            # Si le chemin est relatif ou incorrect, ajouter le préfixe
        ...
        try:
            ...
            delta_file_path = f"hdfs://localhost:9092{delta_path}/{file_type}/"  # Chemin dans Delta
